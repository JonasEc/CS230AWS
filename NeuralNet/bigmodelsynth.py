...
################################################
#%%
X_train, Y_label_train, Y_len_train,  N = loadImgsWithLabels(full=False, synth='Synth')
X_dev, Y_label_dev, Y_len_dev,  Ndev = loadImgsWithLabels(full=False, synth='SynthVal')
...
for i in range(1,len(layer_params)):
    ...
    if i== 7:
#       inner = MaxPool2D(pool_size=(2,1), strides=(2, 2), padding='same', name=f'pool{i+1}')(inner)
